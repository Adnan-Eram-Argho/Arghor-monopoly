...
export const INITIAL_BOARD: Tile[] = [
  ...
  createTile(5, 'Bangladesh Railway', 'STATION', 'STATION', 200, 25),
  ...
  createTile(12, 'Electricity Board', 'UTILITY', 'UTILITY', 150),
  ...
  createTile(15, 'Metro Rail (MRT Line-6)', 'STATION', 'STATION', 200, 25),
  ...
  createProperty(19, 'Bashundhara R/A', 'ORANGE', 200, 16, '#FFA500', 100, [80, 220, 600, 800, 1000]),
  ...
  createTile(25, 'Launch Terminal', 'STATION', 'STATION', 200, 25),
  ...
  createTile(28, 'WASA (Water Supply)', 'UTILITY', 'UTILITY', 150),
  ...
  createTile(35, 'Hazrat Shahjalal Airport', 'STATION', 'STATION', 200, 25),
  createTile(36, 'Luck', 'LUCK'),
  createProperty(37, 'Padma Bridge 🌉', 'DARK_BLUE', 350, 35, '#0000FF', 200, [175, 500, 1100, 1300, 1500]), 
